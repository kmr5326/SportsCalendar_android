...
public class KleagueSchedule {
    ...
    public String getThis_id() { return this_id; }

    public void setThis_id(String this_id) { this.this_id = this_id; }
    ...
    public void setDataCnt(int dataCnt) { this.dataCnt = dataCnt; }
